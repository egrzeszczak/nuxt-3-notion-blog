<template>
    <span
        ...
        :class="{
            ...
            'bg-red-200': element.annotations.color == 'red_background',
            'bg-pink-200': element.annotations.color == 'pink_background',
            'bg-purple-200': element.annotations.color == 'purple_background',
            'bg-blue-200': element.annotations.color == 'blue_background',
            'bg-green-200': element.annotations.color == 'green_background',
            'bg-yellow-200': element.annotations.color == 'yellow_background',
            'bg-orange-200': element.annotations.color == 'orange_background',
            'bg-brown-200': element.annotations.color == 'brown_background',
            'bg-gray-200': element.annotations.color == 'gray_background',
        }"
    >
        <a v-if="element.href" :href="element.href" class="link cursor-pointer">
            {{ element.text.content }} &neArr;
        </a>
        <span v-else>{{ element.text.content }}</span>
    </span>
</template>
