<template>
    <div v-for="block in content" :key="block.id">
        <NotionHeading1 v-if="block.type == 'heading_1' && !block.has_children" :block="block">
        </NotionHeading1>
        <NotionHeading2 v-else-if="block.type == 'heading_2' && !block.has_children" :block="block">
        </NotionHeading2>
        <NotionHeading3 v-else-if="block.type == 'heading_3' && !block.has_children" :block="block">
        </NotionHeading3>
        ...
        <NotionEquation v-else-if="block.type == 'equation'" :expression="block.equation.expression" />
        <NotionDivider v-else-if="block.type == 'divider'" />
        <NotionColumnList v-else-if="block.type == 'column_list'" :block="block"/>
        ...
        <div v-else class="text-red-800 bg-red-100 dark:bg-red-900 dark:text-red-100 text-center p-4 rounded text-xs my-2">
